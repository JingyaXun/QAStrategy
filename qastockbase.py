...
class QAStrategyStockBase(QAStrategyCTABase):
    ...
    def __init__(self, code=['000001'], frequence='1min', strategy_id='QA_STRATEGY', risk_check_gap=1, portfolio='default',
        ...
        self.new_round = True
        self.fund = 1000000
        self.transferable_fund = int(self.fund * 0.9)
        self.buy_fund_max = int(self.fund * 0.9 / 2)
        self.sell_fund_max = self.transferable_fund - self.buy_fund_max
        self.trade_num = 5
        self.s1_num_points = 5
        self.s2_num_points = 5
        self.slope_min = 0.02
        self.skip_round = False
        self.data = data
        self.futures_map = data['futures_map']
        self.trade_list_part1 = data['trade_list_part1']
        self.trade_list_part2 = data['trade_list_part2']
        self.info = {}
